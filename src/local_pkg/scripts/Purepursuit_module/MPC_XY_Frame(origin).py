...
class P:
    ...
    acceleration_max = 100.0  # maximum acceleration [m/s2]
...
def read_global_path():
    global_path_x = []
    global_path_y = []
    with open("/home/gigacha/TEAM-GIGACHA/src/semi_pkg/scripts/maps/Inha_Songdo/right_curve (12point).json", 'r') as json_file:
