...
(cl:defmethod cl:initialize-instance :after ((m <Local>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Local)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name planner_and_control-msg:<Local> is deprecated: use planner_and_control-msg:Local instead.")))
