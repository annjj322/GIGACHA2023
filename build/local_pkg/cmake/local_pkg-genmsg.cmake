...
add_custom_target(_local_pkg_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "local_pkg" "/home/gigacha/TEAM-GIGACHA/src/local_pkg/msg/Control_Info.msg" ""
)

get_filename_component(_filename "/home/gigacha/TEAM-GIGACHA/src/local_pkg/msg/Serial_Info.msg" NAME_WE)
add_custom_target(_local_pkg_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "local_pkg" "/home/gigacha/TEAM-GIGACHA/src/local_pkg/msg/Serial_Info.msg" ""
)
