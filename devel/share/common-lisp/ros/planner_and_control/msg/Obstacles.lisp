...
(cl:defclass <Obstacles> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (segments
    :reader segments
    :initarg :segments
    :type (cl:vector planner_and_control-msg:SegmentObstacle)
   :initform (cl:make-array 0 :element-type 'planner_and_control-msg:SegmentObstacle :initial-element (cl:make-instance 'planner_and_control-msg:SegmentObstacle)))
   (circles
    :reader circles
    :initarg :circles
    :type (cl:vector planner_and_control-msg:CircleObstacle)
   :initform (cl:make-array 0 :element-type 'planner_and_control-msg:CircleObstacle :initial-element (cl:make-instance 'planner_and_control-msg:CircleObstacle))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <Obstacles>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Obstacles)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name planner_and_control-msg:<Obstacles> is deprecated: use planner_and_control-msg:Obstacles instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <Obstacles>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader planner_and_control-msg:header-val is deprecated.  Use planner_and_control-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'segments-val :lambda-list '(m))
(cl:defmethod segments-val ((m <Obstacles>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader planner_and_control-msg:segments-val is deprecated.  Use planner_and_control-msg:segments instead.")
  (segments m))

(cl:ensure-generic-function 'circles-val :lambda-list '(m))
(cl:defmethod circles-val ((m <Obstacles>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader planner_and_control-msg:circles-val is deprecated.  Use planner_and_control-msg:circles instead.")
  (circles m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <Obstacles>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'segments)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'planner_and_control-msg:SegmentObstacle))
  ...
  (cl:let ((vals (cl:slot-value msg 'circles)))
    (cl:dotimes (i __ros_arr_len)
    (cl:setf (cl:aref vals i) (cl:make-instance 'planner_and_control-msg:CircleObstacle))
  (roslisp-msg-protocol:deserialize (cl:aref vals i) istream))))
  msg
)
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Obstacles>)))
  ...
  (cl:format cl:nil "Header header~%~%planner_and_control/SegmentObstacle[] segments~%planner_and_control/CircleObstacle[] circles~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%================================================================================~%MSG: planner_and_control/SegmentObstacle~%geometry_msgs/Point first_point~%geometry_msgs/Point last_point~%~%~%================================================================================~%MSG: geometry_msgs/Point~%# This contains the position of a point in free space~%float64 x~%float64 y~%float64 z~%~%================================================================================~%MSG: planner_and_control/CircleObstacle~%geometry_msgs/Point center~%float64 radius~%~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Obstacles)))
  "Returns full string definition for message of type 'Obstacles"
  (cl:format cl:nil "Header header~%~%planner_and_control/SegmentObstacle[] segments~%planner_and_control/CircleObstacle[] circles~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%================================================================================~%MSG: planner_and_control/SegmentObstacle~%geometry_msgs/Point first_point~%geometry_msgs/Point last_point~%~%~%================================================================================~%MSG: geometry_msgs/Point~%# This contains the position of a point in free space~%float64 x~%float64 y~%float64 z~%~%================================================================================~%MSG: planner_and_control/CircleObstacle~%geometry_msgs/Point center~%float64 radius~%~%~%~%"))
