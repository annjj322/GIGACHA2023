...
"""autogenerated by genpy from planner_and_control/Obstacles.msg. Do not edit."""
import codecs
import sys
...
class Obstacles(genpy.Message):
  ...
  _type = "planner_and_control/Obstacles"
...
"""
  ...
  _slot_types = ['std_msgs/Header','planner_and_control/SegmentObstacle[]','planner_and_control/CircleObstacle[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = planner_and_control.msg.SegmentObstacle()
      ...
      self.circles = []
      for i in range(0, length):
        val1 = planner_and_control.msg.CircleObstacle()
        _v6 = val1.center
        _x = _v6
        start = end
        end += 24
