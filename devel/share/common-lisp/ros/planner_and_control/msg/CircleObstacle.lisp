...
(cl:defmethod cl:initialize-instance :after ((m <CircleObstacle>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'CircleObstacle)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name planner_and_control-msg:<CircleObstacle> is deprecated: use planner_and_control-msg:CircleObstacle instead.")))

(cl:ensure-generic-function 'center-val :lambda-list '(m))
(cl:defmethod center-val ((m <CircleObstacle>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader planner_and_control-msg:center-val is deprecated.  Use planner_and_control-msg:center instead.")
  (center m))

(cl:ensure-generic-function 'radius-val :lambda-list '(m))
(cl:defmethod radius-val ((m <CircleObstacle>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader planner_and_control-msg:radius-val is deprecated.  Use planner_and_control-msg:radius instead.")
  (radius m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<CircleObstacle>)))
  ...
  "planner_and_control/CircleObstacle")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'CircleObstacle)))
  "Returns string type for a message object of type 'CircleObstacle"
  "planner_and_control/CircleObstacle")
